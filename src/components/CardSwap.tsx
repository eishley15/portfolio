...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  useEffect(() => {
    ...
    newOrder.forEach((cardIdx, position) => {
  ...
  }, [activeCardIndex, cardDistance, verticalDistance, skewAmount, refs]);
  ...
  }, [cardDistance, verticalDistance, delay, pauseOnHover, skewAmount, easing, activeCardIndex, refs, config]);
