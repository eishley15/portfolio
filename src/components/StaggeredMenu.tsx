  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Go to home page" href="/">
            <img
...
.sm-scope .sm-logo-img { display: block; height: 4rem; width: auto; object-fit: contain; }
